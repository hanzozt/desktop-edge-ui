...
electron-packager ./zt-edge-ui Ziti-Desktop-Edge --overwrite --asar --electron-version=26.2.4 --platform=win32 --arch=x64 --prune=true  --out=./release-builds --icon=./zt-edge-ui/app.ico
